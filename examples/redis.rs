...
#[get("/show_all_users")]
async fn show_all_users(_auth: Auth<'_>, conn: &State<Users>, user: Option<User>) -> Result<Template, Error> {
...
async fn main() -> Result<(), Error> {
    let mut users = Users::open_mongodb("mongdb://localhost:27017", DATABASE).await?;
